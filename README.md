...
You can refer the [test document](filepath) to see the details of tests you need to pass.

**Note:** 
1. You should use **Solve** function in [Solver](filepath) to solve the challenge.
