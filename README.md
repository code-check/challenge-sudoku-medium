...
The application will send you 3 different sudoku puzzles in the form of two-dimensional array. 
You can refer [Tests.cs](src/Tests.cs) to see the details of tests you need to pass.

**Note:** 
1. You should use **Solve** function in [Solver.cs](src.Solver.cs) to solve the challenge.
2. Some sudoku has multiple solutions, but all of puzzles we provide have a unique solution.
...
## Run Tests
- Build and test command are written in [codecheck.yml](codecheck.yml).
