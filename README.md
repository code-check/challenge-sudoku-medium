...
You can refer the [sudoku_test.go](sudoku_test.go) to see the details of tests you need to pass.

**Note:** 
- You should use **Solve** function in [sudoku.go](sudoku.go) to solve the challenge.
