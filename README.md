...
You can refer the [Tests.scala](src/test/scala/Tests.scala) to see the details of tests you need to pass.

**Note:** 
1. You should use **solveSudoku** function in [Solver.scala](src/main/scala/Solver.scala) to solve the challenge.
